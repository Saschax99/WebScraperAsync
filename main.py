...
import csv, os.path, warnings, asyncio, datetime
...
if __name__ == "__main__":
    try:
        ...
        while True:
            ...
            logging.info(f"ended cycle number {amount_tasks} with {amount} tasks within {str(round((time()-timer_start),4))} seconds")
